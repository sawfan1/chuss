...
public class MyBot :  IChessBot
{
    Board board;
    ulong[] saucyWeights = {
        0x8C9A9C9A9C9A9C9A, 0x7B8A7B8A7B8A7B8A,
        0x4857485748574857,0x3746374637463746,
        0x8B9B8B9B8B9B8B9B,0x7A8B7A8B7A8B7A8B ,
         0x4758475847584758,0x3647364736473647, 
        0x9CAC9CAC9CAC9CAC , 0x8B9C8B9C8B9C8B9C,
        0x5869586958695869,0x4758475847584758,
        0xACBCACBCACBCACBC,0x9BAC9BAC9BAC9BAC,
        0x6879687968796879,0x5768576857685768,
    ...
    {
        int index = (pieceType -(endgame && pieceType == 6 ? 0 : 1)) * 2 +
